...
public class SUModelArmorS2 extends ModelBiped
{
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
  {
      ...
      GL11.glTranslatef(0, 1.5F, 0);
		...
		if ((entityplayer.getEquipmentInSlot(1) != null)
				&& (entityplayer.getEquipmentInSlot(1).getItem() instanceof SUItemArmorS)) {
			SUItemArmorS armor = (SUItemArmorS) entityplayer.getEquipmentInSlot(1).getItem();
		/*if(tankk == null){
			tankk = AdvancedModelLoader.loadModel(new ResourceLocation("strikerunit:textures/model/" + armor.armor_obj));
		}*/
			//tankk = armor.tankk;
		{
			GL11.glPushMatrix();
			GL11.glRotated(20F, 0.0F, 0.0F, 1.0F);
		...
		/*
      AdvancedModelLoader
		.loadModel(new ResourceLocation("strikerunit:textures/model/su01.obj")).renderPart("mat1");
      AdvancedModelLoader
		.loadModel(new ResourceLocation("strikerunit:textures/model/su01.obj")).renderPart("mat3");
      */
      ...
      AdvancedModelLoader
		.loadModel(new ResourceLocation("strikerunit:textures/model/strikerunit.obj")).renderPart("mat1");
      ...
      AdvancedModelLoader
		.loadModel(new ResourceLocation("strikerunit:textures/model/strikerunit.obj")).renderPart("mat2");
